  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          const _TallaZapatoCaja(7),
          const _TallaZapatoCaja(7.5),
          const _TallaZapatoCaja(8),
          const _TallaZapatoCaja(8.5),
          const _TallaZapatoCaja(9),
          const _TallaZapatoCaja(9.5),
        ],
      ),
    );
  }
